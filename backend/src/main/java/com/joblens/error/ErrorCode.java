...
public enum ErrorCode {
    ...
    ANALYSIS_CONTENT_MISMATCH(HttpStatus.BAD_REQUEST,
            "The reviewed content has changed",
            "Review and confirm the resume and job description again, then run the analysis."),
